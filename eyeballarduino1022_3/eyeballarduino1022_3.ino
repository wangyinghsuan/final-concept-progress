...
if(X < 1023 && X >= 0 ) value1 = value1 + (map(X,0,1023,40,120) - value1) * 0.2;

 // if(Y < 1023 && Y >= 0 )value2 = map(Y,0,1023,40,150);
     if(Y < 1023 && Y >= 0 ) value2 = value2 + (map(Y,0,1023,0,100) - value2) * 0.2;
